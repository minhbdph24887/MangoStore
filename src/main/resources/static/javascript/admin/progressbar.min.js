!function (a) {
    ...
    return function () {
        ...
        1: [function (a, b, c) {
            (function (a) {
                (function () {
                    ...
                    function G(a, b) {
                        var c = Cb(a), d = !c && Bb(a), f = !c && !d && Db(a), g = !c && !d && !f && Eb(a),
                            h = c || d || f || g, i = h ? e(a.length, String) : [], j = i.length;
                    ...
                    function Q(a, b, c, d, e) {
                        a !== b && yb(b, function (f, g) {
                            if (e || (e = new A), sa(f)) R(a, b, g, c, Q, d, e); else {
                    ...
                    function R(a, b, c, d, e, f, g) {
                        var h = ka(a, c), i = ka(b, c), j = g.get(i);
                        if (j) return void H(a, c, j);
                        var k = f ? f(h, i, c + "", a, b, g) : void 0, l = void 0 === k;
                        if (l) {
                            var m = Cb(i), n = !m && Db(i), o = !m && !n && Eb(i);
                    ...
                    function T(a, b) {
                        if (b) return a.slice();
                        var c = a.length, d = lb ? lb(c) : new a.constructor(c);
                        return a.copy(d), d
                    }
                    ...
                    function Y(a) {
                        return S(function (b, c) {
                            var d = -1, e = c.length, f = e > 1 ? c[e - 1] : void 0, g = e > 2 ? c[2] : void 0;
                    ...
                    function ja(a, b, c) {
                        return b = tb(void 0 === b ? a.length - 1 : b, 0), function () {
                    ...
                    var Aa = 200, Ba = "__lodash_hash_undefined__", Ca = 800, Da = 16, Ea = 9007199254740991,
                        Fa = "[object Arguments]", Ga = "[object AsyncFunction]", Ha = "[object Function]",
                        Ia = "[object GeneratorFunction]", Ja = "[object Null]", Ka = "[object Object]",
                        La = "[object Proxy]", Ma = "[object Undefined]", Na = /[\\^$.*+?()[\]{}|]/g,
                        Oa = /^\[object .+?Constructor\]$/, Pa = /^(?:0|[1-9]\d*)$/, Qa = {};
                    ...
                    var Ra = "object" == typeof a && a && a.Object === Object && a,
                        ...
                        Ta = Ra || Sa || Function("return this")(), Ua = "object" == typeof c && c && !c.nodeType && c,
                        Va = Ua && "object" == typeof b && b && !b.nodeType && b, Wa = Va && Va.exports === Ua,
                        Xa = Wa && Ra.process, Ya = function () {
                            try {
                                var a = Va && Va.require && Va.require("util").types;
                                return a || Xa && Xa.binding && Xa.binding("util")
                            } catch (a) {
                            }
                        }(), Za = Ya && Ya.isTypedArray, $a = Array.prototype, _a = Function.prototype,
                        ab = Object.prototype, bb = Ta["__core-js_shared__"], cb = _a.toString, db = ab.hasOwnProperty,
                        eb = function () {
                            var a = /[^.]+$/.exec(bb && bb.keys && bb.keys.IE_PROTO || "");
                            return a ? "Symbol(src)_1." + a : ""
                        }(), fb = ab.toString, gb = cb.call(Object),
                        hb = RegExp("^" + cb.call(db).replace(Na, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                        ib = Wa ? Ta.Buffer : void 0, jb = Ta.Symbol, kb = Ta.Uint8Array,
                        lb = ib ? ib.allocUnsafe : void 0, mb = h(Object.getPrototypeOf, Object), nb = Object.create,
                        ob = ab.propertyIsEnumerable, pb = $a.splice, qb = jb ? jb.toStringTag : void 0,
                        rb = function () {
                            try {
                        ...
                        }(), sb = ib ? ib.isBuffer : void 0, tb = Math.max, ub = Date.now, vb = _(Ta, "Map"),
                        wb = _(Object, "create"), xb = function () {
                            function a() {
                            }
                    ...
                    var yb = Z(), zb = rb ? function (a, b) {
                        return rb(a, "toString", {configurable: !0, enumerable: !1, value: xa(b), writable: !0})
                    } : ya, Ab = la(zb), Bb = M(function () {
                        return arguments
                    }()) ? M : function (a) {
                        return ta(a) && db.call(a, "callee") && !ob.call(a, "callee")
                    }, Cb = Array.isArray, Db = sb || za, Eb = Za ? f(Za) : O, Fb = Y(function (a, b, c) {
                        Q(a, b, c)
                    });
                    b.exports = Fb
                }).call(this)
                ...
                return function () {
                    ...
                    var b = {
                        720: function (a, b, c) {
                            ...
                            function m() {
                                var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, b = new La;
                            ...
                            function q(a) {
                                ...
                                [b, c, d].forEach(function (a) {
                                    return function (a, b) {
                                        for (var c in b) {
                                            var d = b[c], e = d.chunkNames, f = d.formatString,
                                                g = bb(f, ab(_a(a, e), e));
                                            a[c] = Xa(Ra, g, Za)
                                        }
                                    }(a, f)
                            ...
                            var A, B, C, D, E = function (a) {
                                ...
                                }, oa = "linear", pa = "undefined" != typeof window ? window : c.g, qa = "afterTween",
                                ra = "afterTweenEnd", sa = "beforeTween", ta = "tweenCreated", ua = "function",
                                va = "string",
                                ...
                                xa = function () {
                                }, ya = null, za = null, Aa = k({}, y), Ba = function (a, b, c, d, e, f, g) {
                                    var h, i, j, k = a < f ? 0 : (a - f) / e, l = !1;
                                    for (var m in g && g.call && (l = !0, h = g(k)), b) l || (h = ((i = g[m]).call ? i : Aa[i])(k)), j = c[m], b[m] = j + (d[m] - j) * h;
                                    return b
                                }, Ca = function (a, b) {
                                    var c = a._timestamp, d = a._currentState, e = a._delay;
                                    if (!(b < c + e)) {
                                        var f = a._duration, g = a._targetState, h = c + e + f, i = b > h ? h : b;
                                        a._hasEnded = i >= h;
                                        var j = f - (h - i), k = a._filters.length > 0;
                                    ...
                                    var d = g(b);
                                    if (Aa[b]) return Aa[b];
                                    if (d === va || d === ua) for (var e in a) c[e] = b; else for (var f in a) c[f] = b[f] || oa;
                                    return c
                                }, Ja = function (a) {
                            ...
                            var La = function () {
                                ...
                                return b = a, c = [{
                                    ...
                                    key: "setConfig", value: function () {
                                        ...
                                        var e = c.promise, f = void 0 === e ? this._promiseCtor : e, h = c.start,
                                            i = void 0 === h ? xa : h, j = c.finish, k = c.render,
                                            l = void 0 === k ? this._config.step || xa : k, m = c.step,
                                            n = void 0 === m ? xa : m;
                                        ...
                                        var o = b.from, p = b.to, q = void 0 === p ? {} : p, r = this._currentState,
                                            s = this._originalState, t = this._targetState;
                                    ...
                                    key: "catch", value: function (a) {
                                        return this.then().catch(a)
                                    }
                                }, {
                                    key: "finally", value: function (a) {
                                    ...
                                    key: "cancel", value: function () {
                                        var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                                            b = this._currentState, c = this._data;
                            ...
                            var Ma, Na, Oa = /(\d|-|\.)/, Pa = /([^\-0-9.]+)/g, Qa = /[0-9.-]+/g,
                                ...
                                Sa = /^.*\(/, Ta = /#([0-9]|[a-f]){3,6}/gi, Ua = "VAL", Va = function (a, b) {
                                    ...
                                    var d = b.match(a), e = b.replace(a, Ua);
                                    ...
                                    var b = a.match(Qa), c = b.slice(0, 3).map(Math.floor), d = a.match(Sa)[0];
                                    ...
                                    for (var b in a._currentState) if ("string" == typeof a._currentState[b]) return !0;
                                    return !1
        ...
        10: [function (a, b, c) {
            ...
            var o = a("lodash.merge"), p = "Webkit Moz O ms".split(" "), q = .001;
            b.exports = {
                extend: o,
                render: d,
                setStyle: e,
